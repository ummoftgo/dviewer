...
- PDFs open up to 256 MiB. PDF.js provides page navigation, zoom, rotation, search, text selection/copy and outlines; sessions restore the page number. Source view, editing, OCR and password-protected documents are unsupported. Pages without text show a search/copy notice. Searching may read every PDF page and can be expensive on large documents.
