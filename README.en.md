...
- **Excel and Parquet open inside an archive and from a URL too.** Both are read through a reader that takes bytes, so neither has to be a file. The ceilings are unchanged: 64MB for a workbook, and 512MB for anything downloaded.
