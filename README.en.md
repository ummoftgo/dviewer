...
| Frame | HTML (.html/.htm/.xhtml) | Scripts, local modules and web fonts in an isolated origin; TOC, Ctrl+F search, Ctrl+E line-indexed source, relative document links, per-document external-resource controls, and sibling resources for HTML in local ZIP files |
