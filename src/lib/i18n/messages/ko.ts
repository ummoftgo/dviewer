...
export const ko = {
  ...
  "bookmarks.current": "현재 문서",
  "bookmarks.all": "전체",
  "bookmarks.filter": "라벨·문서명 필터",
  "bookmarks.rename": "이름 변경",
  "bookmarks.delete": "책갈피 삭제",
  "bookmarks.actions": "책갈피 메뉴",
  "bookmarks.reassign": "현재 위치로 재지정",
  "bookmarks.clear": "책갈피 모두 지우기",
  "bookmarks.clearQuestion": "모든 책갈피를 지울까요?",
  "bookmarks.clearHint": "닫힌 문서의 책갈피도 지워집니다. 되돌릴 수 없습니다.",
  "bookmarks.add": "책갈피 추가 (Ctrl+D)",
  "bookmarks.toggle": "책갈피 패널 (Ctrl+Shift+B)",
  "bookmarks.close": "책갈피 패널 닫기",
  "bookmarks.label": "라벨",
  "bookmarks.save": "저장",
  "bookmarks.cancel": "취소",
  "bookmarks.top": "문서 맨 위",
  "bookmarks.missing": "못 찾음",
  "bookmarks.empty": "책갈피가 없습니다.",
  "bookmarks.loadFailed": "책갈피를 읽지 못했습니다. 다시 실행해 주세요. 기존 책갈피는 덮어쓰지 않습니다.",
  "bookmarks.saveFailed": "책갈피를 저장하지 못했습니다. 이 창에서는 유지되지만 다시 실행하면 사라질 수 있습니다.",
  ...
  "frame.allow": "이 문서에서 외부 자원 허용",
  "frame.block": "다시 차단",
  "frame.allowed": "외부 자원 허용됨",
  ...
  "grid.previewText": "미리보기는 {chars}자까지입니다. 값 복사(최대 8 MiB)나 원문 보기로 더 많은 내용을 확인할 수 있습니다.",
  "grid.previewValue": "미리보기는 {chars}자까지입니다. 값 복사(최대 8 MiB)로 더 많은 내용을 확인할 수 있습니다.",
  "grid.previewBinary": "바이너리 미리보기는 {bytes}바이트까지입니다. 값 복사(최대 8 MiB)로 더 많은 내용을 확인할 수 있습니다.",
  "grid.previewChars": "잘린 미리보기 · {chars}자",
  "grid.previewBytes": "잘린 미리보기 · {bytes}바이트",
