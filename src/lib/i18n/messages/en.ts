...
export const en: Messages = {
  ...
  "bookmarks.current": "Current document",
  "bookmarks.all": "All",
  "bookmarks.filter": "Filter labels and document names",
  "bookmarks.rename": "Rename",
  "bookmarks.delete": "Delete bookmark",
  "bookmarks.actions": "Bookmark menu",
  "bookmarks.reassign": "Assign current location",
  "bookmarks.clear": "Clear all bookmarks",
  "bookmarks.clearQuestion": "Clear all bookmarks?",
  "bookmarks.clearHint": "Bookmarks in closed documents will also be deleted. This cannot be undone.",
  "bookmarks.add": "Add bookmark (Ctrl+D)",
  "bookmarks.toggle": "Bookmarks panel (Ctrl+Shift+B)",
  "bookmarks.close": "Close bookmarks panel",
  "bookmarks.label": "Label",
  "bookmarks.save": "Save",
  "bookmarks.cancel": "Cancel",
  "bookmarks.top": "Top of document",
  "bookmarks.missing": "Not found",
  "bookmarks.empty": "No bookmarks.",
  "bookmarks.loadFailed": "Could not load bookmarks. Please restart the app. Existing bookmarks will not be overwritten.",
  "bookmarks.saveFailed": "Could not save bookmarks. They remain in this window but may be lost after restarting.",
  ...
  "settings.autoReload": "Reload when a file changes",
  "doc.changed": "The file has changed",
  ...
  "grid.sortDefault": "Original order",
  ...
  "grid.fitColumn": "Fit column width",
  "grid.filterIn": "In {column}",
  "grid.filterAll": "Filter all columns",
  ...
  "frame.allow": "Allow external resources for this document",
  "frame.block": "Block again",
  "frame.allowed": "External resources allowed",
  ...
  "markdown.search.placeholder": "Find in document (Ctrl+F)",
  "markdown.search.regex": "Find by regular expression",
  "markdown.search.capped": "More than 2,000 matches; only the first matches are shown.",
  "markdown.search.close": "Close search (Esc)",
  "markdown.search.length": "Regular expressions are limited to 256 characters.",
  "markdown.search.pattern": "The regular expression is invalid.",
  "markdown.search.timeout": "Search stopped after 1 second. Try a simpler regular expression.",
  "markdown.search.worker": "Search could not run. Please try again.",
  "markdown.search.noHighlight": "This environment scrolls to matches without highlighting them.",
  ...
  "grid.previewText": "Previews show up to {chars} characters. Use Copy value (up to 8 MiB) or Source view to see more.",
  "grid.previewValue": "Previews show up to {chars} characters. Use Copy value (up to 8 MiB) to see more.",
  "grid.previewBinary": "Binary previews show up to {bytes} bytes. Use Copy value (up to 8 MiB) to see more.",
  "grid.previewChars": "Truncated preview · {chars} characters",
  "grid.previewBytes": "Truncated preview · {bytes} bytes",
  ...
  "update.noKey": "Update checks are unavailable because no signing key is configured.",
  "update.checkNow": "Check now",
  "update.checking": "Checking…",
  "update.available": "Update available: v{version}",
  "update.current": "No newer version is available.",
  "update.install": "Update now",
  "update.later": "Later",
  "update.skip": "Skip this version",
  "update.release": "Release page",
  "update.linkOnly": "Download and install this distribution from the release page.",
  "update.reopenWarning": "The app restarts after updating and reopens original files and URLs. Pasted documents, derived tabs, window layouts and selections are not restored.",
  "update.downloading": "Downloading update…",
  "update.installing": "Installing update…",
  "update.cancel": "Cancel download",
  "update.flavor.nsis": "Windows NSIS installer",
  "update.flavor.msi": "Windows MSI installer",
  "update.flavor.portableExe": "Windows portable exe",
  "update.flavor.macApp": "macOS app",
  "update.flavor.appImage": "Linux AppImage",
  "update.flavor.package": "Linux package",
  "update.flavor.unknown": "Unidentified distribution",
  ...
  "error.tooManyLines": "Too many source lines (limit {limit}). Try splitting the file.",
  "textRaw.find": "Find in source (Ctrl+F)",
  "textRaw.line": "Line {line}",
  "textRaw.goTo": "Go to line",
  "textRaw.go": "Go",
  ...
  "markdown.copy.mathmlDone": "MathML copied",
  "markdown.copy.svg": "Copy as SVG",
  "markdown.copy.pngDone": "PNG {width}×{height} copied",
  "markdown.copy.pngReduced": "PNG {width}×{height} copied (reduced to the 4096px limit)",
  "markdown.copy.svgDone": "SVG copied",
  "markdown.copy.imageFailed": "Could not copy the image.",
  "markdown.copy.all": "Copy all",
  "markdown.copy.question": "What would you like to copy?",
  "markdown.copy.raw": "Copy Markdown source",
  "markdown.copy.html": "Copy HTML",
  "markdown.copy.cancel": "Cancel",
  "markdown.copy.childrenQuestion": "Include the section contents?",
  "markdown.copy.headingOnly": "Heading only",
  "markdown.copy.withChildren": "Include contents",
  "markdown.copy.rawDone": "Source copied",
  "markdown.copy.htmlDone": "HTML copied",
  "markdown.copy.noSource": "The source position of this block is unavailable.",
  "markdown.copy.block": "Copy block · ↑↓ previous/next block",
  "markdown.copy.code": "Copy code only",
  "markdown.copy.codeDone": "Copied {n} code characters",
  "markdown.code.unknown": "Unknown: {name}",
  "markdown.code.language": "Change code language",
