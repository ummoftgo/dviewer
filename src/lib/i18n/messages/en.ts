...
export const en: Messages = {
  ...
  "tree.depth": "Depth",
  "tree.depth.title": "Return to this much expanded (up to {max})",
  ...
  "subject.document": "the document",
  "subject.markdown": "Markdown rendering",
  "subject.source": "the source",
  "subject.json": "JSON",
  "subject.yaml": "YAML",
  "subject.toml": "TOML",
  "subject.xml": "XML",
  "subject.table": "the table",
  "subject.tree": "the tree",
  ...
  "error.tooLarge": "{subject} is too large ({megabytes}MB). Up to {limitMb}MB is supported.",
  "error.tooManyNodes": "Too many nodes (limit {limit}). Try splitting the file.",
  "error.tooDeep": "{subject} is nested too deeply (limit {limit}).",
  "error.notReady": "Still reading {subject}.",
  "error.wrongView": "This format cannot be shown as {subject}.",
