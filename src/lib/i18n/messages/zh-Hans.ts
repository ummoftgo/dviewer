...
export const zhHans: Messages = {
  ...
  "bookmarks.current": "当前文档",
  "bookmarks.all": "全部",
  "bookmarks.filter": "按标签和文档名筛选",
  "bookmarks.rename": "重命名",
  "bookmarks.delete": "删除书签",
  "bookmarks.actions": "书签菜单",
  "bookmarks.reassign": "重新指定为当前位置",
  "bookmarks.clear": "清除所有书签",
  "bookmarks.clearQuestion": "清除所有书签？",
  "bookmarks.clearHint": "已关闭文档的书签也会被删除。此操作无法撤销。",
  "bookmarks.add": "添加书签 (Ctrl+D)",
  "bookmarks.toggle": "书签面板 (Ctrl+Shift+B)",
  "bookmarks.close": "关闭书签面板",
  "bookmarks.label": "标签",
  "bookmarks.save": "保存",
  "bookmarks.cancel": "取消",
  "bookmarks.top": "文档顶部",
  "bookmarks.missing": "未找到",
  "bookmarks.empty": "没有书签。",
  "bookmarks.loadFailed": "无法读取书签。请重新启动应用。现有书签不会被覆盖。",
  "bookmarks.saveFailed": "无法保存书签。书签会保留在此窗口中，但重新启动后可能丢失。",
  ...
  "frame.allow": "允许此文档的外部资源",
  "frame.block": "重新阻止",
  "frame.allowed": "已允许外部资源",
  ...
  "grid.previewText": "预览最多显示 {chars} 个字符。使用复制值（最多 8 MiB）或原文视图查看更多内容。",
  "grid.previewValue": "预览最多显示 {chars} 个字符。使用复制值（最多 8 MiB）查看更多内容。",
  "grid.previewBinary": "二进制预览最多显示 {bytes} 字节。使用复制值（最多 8 MiB）查看更多内容。",
  "grid.previewChars": "截断的预览 · {chars} 个字符",
  "grid.previewBytes": "截断的预览 · {bytes} 字节",
