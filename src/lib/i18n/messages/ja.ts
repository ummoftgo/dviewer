...
export const ja: Messages = {
  ...
  // --- 시작 화면 / start pane ------------------------------------------------
  "start.intro": "Markdown · JSON · YAML · TOML · XML · CSV · TSV を開きます。ウィンドウにファイルをドロップしても構いません。",
  ...
  "font.monospace": "等幅",
  "font.other": "その他",
  "font.hint": "既定のフォントにない文字は補助フォントが描きます。プレビューですべての文字が意図どおりか確認してください。",
  ...
  "inspector.more": "さらに {n} 件",
  "inspector.loading": "読み込み中…",
  "inspector.keyWidth": "キー列の幅",

  // --- 트리 검색 / tree search -----------------------------------------------
  "search.scope.all": "すべて",
  "search.scope.all.title": "キーと値から探す",
  "search.scope.keys": "キー",
  "search.scope.keys.title": "キーだけを探す",
  "search.scope.values": "値",
  "search.scope.values.title": "値だけを探す",
  "search.scope.paths": "パス",
  "search.scope.paths.title": "$.items[3].name のようなパスから探す",
  "search.placeholder": "キーと値から探す (Ctrl+F)",
  "search.placeholder.paths": "パスから探す — 例: items[3].name",
  ...
  "table.search.placeholder": "表の中から探す",
  "table.search.run": "検索",
  ...
  "error.tooLarge": "{subject}が大きすぎます ({megabytes}MB)。{limitMb}MB まで対応します。",
