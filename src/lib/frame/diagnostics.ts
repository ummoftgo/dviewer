...
export function frameDiagnostic(tab: Pick<DocTab, 'frameUrlPort' | 'frameLoaded' | 'frameReady' | 'frameError' | 'frameServed' | 'frameCsp' | 'frameAgentStarted' | 'frameStages' | 'frameStall' | 'frameOrientation'>): string {
